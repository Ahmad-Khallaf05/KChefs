...
<div class="content">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('ChefDishes.dashboard.create') }}">
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    {{-- Filter by Category --}}
                    <form method="GET" action="{{ route('ChefDishes.dashboard.index') }}" class="d-flex align-items-center">
                        ...
                        <tbody>
                            @foreach($dishes as $dish)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('ChefDishes.dashboard.show', $dish) }}" class="btn btn-info btn-sm">View</a>
                                        <a href="{{ route('ChefDishes.dashboard.edit', $dish) }}" class="btn btn-warning btn-sm">Edit</a>
                                        <button class="btn btn-danger btn-sm" onclick="confirmDelete('{{ route('ChefDishes.dashboard.destroy', $dish) }}')">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
