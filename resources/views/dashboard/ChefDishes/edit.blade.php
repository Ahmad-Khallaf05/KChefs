    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- Edit Form --}}
                <form method="POST" action="{{ route('ChefDishes.dashboard.update', $dish) }}">
                    @csrf
                    @method('PUT')

                    <div class="form-group">
                        <label for="dish_title">Dish Name</label>
                        <input type="text" name="dish_title" id="dish_title" class="form-control" value="{{ old('dish_title', $dish->dish_title) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="5">{{ old('description', $dish->description) }}</textarea>
                    </div>
